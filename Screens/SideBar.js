...
const routes = [{text:"Services",icon:"box","route":"Services"},{text:"Market Data",icon:"trending-up","route":"TabsClass"},
    {text:"Contact Us",icon:"mail","route":"Contact"},{text:"Find Us",icon:"map-pin","route":"Map"},{text: "Downloads",icon:"download","route":"Downloads"}
    , {text:"Economic Reports",icon:"align-center","route":"News"},{text: "Notifications",icon:"bell","route":"NotificationsClass"}];
        ...
        return (
            ...
            <Container style={{flex:1}}>
                ...
                <View style={{height:150,justifyContent:"center"}}>
                    <Image source={require('../Assets/cdhlogo.png')} style={{width:100,height:60,alignSelf:"center",resizeMode:'contain'}}/>
                </View>
                    <List
                        dataArray={routes}
                        renderRow={data => {
