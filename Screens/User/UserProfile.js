...
export default class UserProfile extends React.Component {
    ...
    send(name,email,phone,message){
        ...
        fetch("https://appfarm.000webhostapp.com/acl/acl_app/change.php", {
            method: "POST",
            headers: {
            ...
            <StyleProvider style={getTheme(platform)}>
                <Container style={{backgroundColor:"#FFF"}}>
                    ...
                    <Content padder>
                        ...
                        <Form>
                            <Item rounded style={{marginTop:20,backgroundColor:"#fff",borderColor:"#fff"}}>
                            ...
                            <Item rounded style={{marginTop:20,backgroundColor:"#fff",borderColor:"#fff"}}>
                                ...
                                <Item rounded style={{marginTop:20,backgroundColor:"#fff",borderColor:"#fff"}}>
                                    <Input onChangeText={this.handleName} placeholder='Click here to change Password' style={{padding:5}}/>
                            </Item>
                        </Form>
                        <Button onPress={()=>this.send(this.state.name,this.state.email,this.state.phone,this.state.message)} block style={{marginTop:20,borderRadius:5}}>
                            <Text style={{ fontFamily: 'Roboto'}}>Save</Text>
                        </Button>
                    </Content>
                </Container>
            </StyleProvider>
